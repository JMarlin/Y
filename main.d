...
typedef char* (*ASTNodeCleaner)(struct ASTNode_s*);





char* ASTModuleNode_print(struct ASTNode_s*); void ASTModuleNode_cleanUp(struct ASTNode_s*);;
char* ASTStatementNode_print(struct ASTNode_s*); void ASTStatementNode_cleanUp(struct ASTNode_s*);;
char* ASTExpressionNode_print(struct ASTNode_s*); void ASTExpressionNode_cleanUp(struct ASTNode_s*);;
char* ASTLambdaNode_print(struct ASTNode_s*); void ASTLambdaNode_cleanUp(struct ASTNode_s*);;
char* ASTLiteralValueNode_print(struct ASTNode_s*); void ASTLiteralValueNode_cleanUp(struct ASTNode_s*);;
char* ASTOperatorNode_print(struct ASTNode_s*); void ASTOperatorNode_cleanUp(struct ASTNode_s*);;
...
const ASTNodeMethods ASTNodeMethodsFor[] = {
    (ASTNodeMethods){ ASTModuleNode_print; ASTModuleNode_cleanUp; },
    (ASTNodeMethods){ ASTStatementNode_print; ASTStatementNode_cleanUp; },
    (ASTNodeMethods){ ASTExpressionNode_print; ASTExpressionNode_cleanUp; },
    (ASTNodeMethods){ ASTLambdaNode_print; ASTLambdaNode_cleanUp; },
    (ASTNodeMethods){ ASTLiteralValueNode_print; ASTLiteralValueNode_cleanUp; },
    (ASTNodeMethods){ ASTOperatorNode_print; ASTOperatorNode_cleanUp; }
};
...
char* OperatorExpression_tryParse(FILE*, ASTExpressionNode**);;
char* LambdaExpression_tryParse(FILE*, ASTExpressionNode**);;
...
const ExpressionNodeMethods ExpressionMethodsFor[] = {
    (ASTNodeMethods){ OperatorExpression_tryParse; },
    (ASTNodeMethods){ LambdaExpression_tryParse; }
}

char* ASTExpressionNode_tryParse(FILE* in_file, ASTExpressionNode** expression_node) {

    for(int i = 0; i < ExpressionType.Count; i++)
